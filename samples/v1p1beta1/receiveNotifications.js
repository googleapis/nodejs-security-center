...
function main(
    projectId = 'your-project-id', subscriptionId = 'your-subscription-id') {
  ...
  protoFilesRoot = protobuf.loadSync(
      path.join(
          __dirname, '..', 'node_modules', '@google-cloud', 'security-center',
          'build', 'protos', 'google', 'cloud', 'securitycenter', 'v1p1beta1',
  ...
  function listenForMessages() {
    ...
    const messageHandler = message => {
      ...
      const parsedNotificationMessage =
          NotificationMessage.create(JSON.parse(jsonString));
