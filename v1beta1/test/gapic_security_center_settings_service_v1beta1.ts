...
describe('v1beta1.SecurityCenterSettingsServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      securitycentersettingsserviceModule.v1beta1
        .SecurityCenterSettingsServiceClient.servicePath;
    assert(servicePath);
  });
  ...
  it('has apiEndpoint', () => {
    const apiEndpoint =
      securitycentersettingsserviceModule.v1beta1
        .SecurityCenterSettingsServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  it('has port', () => {
    const port =
      securitycentersettingsserviceModule.v1beta1
        .SecurityCenterSettingsServiceClient.port;
    assert(port);
  ...
  describe('getServiceAccount', () => {
    ...
    it('invokes getServiceAccount without error using callback', async () => {
      ...
      client.innerApiCalls.getServiceAccount = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getServiceAccount(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securitycenter.settings.v1beta1.IServiceAccount | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getSettings', () => {
    ...
    it('invokes getSettings without error using callback', async () => {
      ...
      client.innerApiCalls.getSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securitycenter.settings.v1beta1.ISettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateSettings', () => {
    ...
    it('invokes updateSettings without error using callback', async () => {
      ...
      client.innerApiCalls.updateSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('resetSettings', () => {
    it('invokes resetSettings without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.resetSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes resetSettings without error using callback', async () => {
      ...
      client.innerApiCalls.resetSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes resetSettings with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.resetSettings = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('batchGetSettings', () => {
    it('invokes batchGetSettings without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.batchGetSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes batchGetSettings without error using callback', async () => {
      ...
      client.innerApiCalls.batchGetSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.batchGetSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securitycenter.settings.v1beta1.IBatchGetSettingsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes batchGetSettings with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.batchGetSettings = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('calculateEffectiveSettings', () => {
    it('invokes calculateEffectiveSettings without error', async () => {
      ...
      client.innerApiCalls.calculateEffectiveSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.calculateEffectiveSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.calculateEffectiveSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes calculateEffectiveSettings without error using callback', async () => {
      ...
      client.innerApiCalls.calculateEffectiveSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes calculateEffectiveSettings with error', async () => {
      ...
      await assert.rejects(
        client.calculateEffectiveSettings(request),
        expectedError
      );
      assert(
        (client.innerApiCalls.calculateEffectiveSettings as SinonStub)
  ...
  describe('batchCalculateEffectiveSettings', () => {
    it('invokes batchCalculateEffectiveSettings without error', async () => {
      ...
      client.innerApiCalls.batchCalculateEffectiveSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.batchCalculateEffectiveSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.batchCalculateEffectiveSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes batchCalculateEffectiveSettings without error using callback', async () => {
      ...
      client.innerApiCalls.batchCalculateEffectiveSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.batchCalculateEffectiveSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securitycenter.settings.v1beta1.IBatchCalculateEffectiveSettingsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getComponentSettings', () => {
    it('invokes getComponentSettings without error', async () => {
      ...
      client.innerApiCalls.getComponentSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.getComponentSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.getComponentSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes getComponentSettings without error using callback', async () => {
      ...
      client.innerApiCalls.getComponentSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getComponentSettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.securitycenter.settings.v1beta1.IComponentSettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('updateComponentSettings', () => {
    it('invokes updateComponentSettings without error', async () => {
      ...
      client.innerApiCalls.updateComponentSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.updateComponentSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.updateComponentSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes updateComponentSettings without error using callback', async () => {
      ...
      client.innerApiCalls.updateComponentSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes updateComponentSettings with error', async () => {
      ...
      await assert.rejects(
        client.updateComponentSettings(request),
        expectedError
      );
      assert(
        (client.innerApiCalls.updateComponentSettings as SinonStub)
  ...
  describe('resetComponentSettings', () => {
    it('invokes resetComponentSettings without error', async () => {
      ...
      client.innerApiCalls.resetComponentSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.resetComponentSettings(request);
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.resetComponentSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes resetComponentSettings without error using callback', async () => {
      ...
      client.innerApiCalls.resetComponentSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('calculateEffectiveComponentSettings', () => {
    it('invokes calculateEffectiveComponentSettings without error', async () => {
      ...
      client.innerApiCalls.calculateEffectiveComponentSettings = stubSimpleCall(
        expectedResponse
      );
      const [response] = await client.calculateEffectiveComponentSettings(
        request
      );
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.calculateEffectiveComponentSettings as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes calculateEffectiveComponentSettings without error using callback', async () => {
      ...
      client.innerApiCalls.calculateEffectiveComponentSettings = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes calculateEffectiveComponentSettings with error', async () => {
      ...
      await assert.rejects(
        client.calculateEffectiveComponentSettings(request),
        expectedError
      );
      assert(
        (client.innerApiCalls.calculateEffectiveComponentSettings as SinonStub)
  ...
  describe('listDetectors', () => {
    it('invokes listDetectors without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.securitycenter.settings.v1beta1.Detector()
        ),
        generateSampleMessage(
          new protos.google.cloud.securitycenter.settings.v1beta1.Detector()
        ),
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.listDetectors as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes listDetectors without error using callback', async () => {
      ...
      client.innerApiCalls.listDetectors = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listDetectors with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.listDetectors = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listDetectorsStream without error', async () => {
      ...
      client.descriptors.page.listDetectors.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.securitycenter.settings.v1beta1.Detector
          ) => {
      ...
      assert(
        (client.descriptors.page.listDetectors.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listDetectors, request)
      );
      assert.strictEqual(
        (client.descriptors.page.listDetectors
    ...
    it('uses async iteration with listDetectors without error', async () => {
      ...
      client.descriptors.page.listDetectors.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
  ...
  describe('listComponents', () => {
    it('invokes listComponents without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      assert(
        (client.innerApiCalls.listComponents as SinonStub)
          .getCall(0)
          .calledWith(request, expectedOptions, undefined)
      );
    });
    ...
    it('invokes listComponents without error using callback', async () => {
      ...
      const expectedResponse = [new String(), new String(), new String()];
      client.innerApiCalls.listComponents = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listComponents with error', async () => {
      ...
      const expectedError = new Error('expected');
      client.innerApiCalls.listComponents = stubSimpleCall(
        undefined,
        expectedError
      );
    ...
    it('invokes listComponentsStream without error', async () => {
      ...
      const expectedHeaderRequestParams = 'parent=';
      const expectedResponse = [new String(), new String(), new String()];
      client.descriptors.page.listComponents.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert(
        (client.descriptors.page.listComponents.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listComponents, request)
      );
      assert.strictEqual(
        (client.descriptors.page.listComponents
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('uses async iteration with listComponents without error', async () => {
      ...
      const expectedHeaderRequestParams = 'parent=';
      const expectedResponse = [new String(), new String(), new String()];
      client.descriptors.page.listComponents.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
      const responses: string[] = [];
  ...
  describe('Path templates', () => {
    describe('folderComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.folderComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.folderComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('folderComponentSettingsPath', () => {
        const result = client.folderComponentSettingsPath(
          'folderValue',
          'componentValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.folderComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
      ...
      it('matchFolderFromFolderComponentSettingsName', () => {
        const result = client.matchFolderFromFolderComponentSettingsName(
          fakePath
        );
      ...
      it('matchComponentFromFolderComponentSettingsName', () => {
        const result = client.matchComponentFromFolderComponentSettingsName(
          fakePath
        );
    ...
    describe('organizationComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.organizationComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.organizationComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('organizationComponentSettingsPath', () => {
        const result = client.organizationComponentSettingsPath(
          'organizationValue',
          'componentValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.organizationComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchOrganizationFromOrganizationComponentSettingsName', () => {
        const result = client.matchOrganizationFromOrganizationComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchComponentFromOrganizationComponentSettingsName', () => {
        const result = client.matchComponentFromOrganizationComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'componentValue');
        assert(
    ...
    describe('projectComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectComponentSettingsPath', () => {
        const result = client.projectComponentSettingsPath(
          'projectValue',
          'componentValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectComponentSettingsName', () => {
        const result = client.matchProjectFromProjectComponentSettingsName(
          fakePath
        );
      ...
      it('matchComponentFromProjectComponentSettingsName', () => {
        const result = client.matchComponentFromProjectComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'componentValue');
        assert(
    ...
    describe('projectLocationClusterComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectLocationClusterComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationClusterComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationClusterComponentSettingsPath', () => {
        const result = client.projectLocationClusterComponentSettingsPath(
          'projectValue',
          'locationValue',
          'clusterValue',
          'componentValue'
        ...
        assert(
          (client.pathTemplates
            .projectLocationClusterComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectLocationClusterComponentSettingsName', () => {
        const result = client.matchProjectFromProjectLocationClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationClusterComponentSettingsName', () => {
        const result = client.matchLocationFromProjectLocationClusterComponentSettingsName(
          fakePath
        );
      ...
      it('matchClusterFromProjectLocationClusterComponentSettingsName', () => {
        const result = client.matchClusterFromProjectLocationClusterComponentSettingsName(
          fakePath
        );
      ...
      it('matchComponentFromProjectLocationClusterComponentSettingsName', () => {
        const result = client.matchComponentFromProjectLocationClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'componentValue');
        assert(
    ...
    describe('projectLocationClusterSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectLocationClusterSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectLocationClusterSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectLocationClusterSettingsPath', () => {
        const result = client.projectLocationClusterSettingsPath(
          'projectValue',
          'locationValue',
          'clusterValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectLocationClusterSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectLocationClusterSettingsName', () => {
        const result = client.matchProjectFromProjectLocationClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchLocationFromProjectLocationClusterSettingsName', () => {
        const result = client.matchLocationFromProjectLocationClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchClusterFromProjectLocationClusterSettingsName', () => {
        const result = client.matchClusterFromProjectLocationClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'clusterValue');
        assert(
    ...
    describe('projectRegionClusterComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectRegionClusterComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectRegionClusterComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectRegionClusterComponentSettingsPath', () => {
        const result = client.projectRegionClusterComponentSettingsPath(
          'projectValue',
          'regionValue',
          'clusterValue',
          'componentValue'
        ...
        assert(
          (client.pathTemplates
            .projectRegionClusterComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectRegionClusterComponentSettingsName', () => {
        const result = client.matchProjectFromProjectRegionClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchRegionFromProjectRegionClusterComponentSettingsName', () => {
        const result = client.matchRegionFromProjectRegionClusterComponentSettingsName(
          fakePath
        );
      ...
      it('matchClusterFromProjectRegionClusterComponentSettingsName', () => {
        const result = client.matchClusterFromProjectRegionClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'clusterValue');
        assert(
      ...
      it('matchComponentFromProjectRegionClusterComponentSettingsName', () => {
        const result = client.matchComponentFromProjectRegionClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'componentValue');
        assert(
    ...
    describe('projectRegionClusterSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectRegionClusterSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectRegionClusterSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectRegionClusterSettingsPath', () => {
        const result = client.projectRegionClusterSettingsPath(
          'projectValue',
          'regionValue',
          'clusterValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectRegionClusterSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectRegionClusterSettingsName', () => {
        const result = client.matchProjectFromProjectRegionClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchRegionFromProjectRegionClusterSettingsName', () => {
        const result = client.matchRegionFromProjectRegionClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'regionValue');
        assert(
      ...
      it('matchClusterFromProjectRegionClusterSettingsName', () => {
        const result = client.matchClusterFromProjectRegionClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'clusterValue');
        assert(
    ...
    describe('projectZoneClusterComponentSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectZoneClusterComponentSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectZoneClusterComponentSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectZoneClusterComponentSettingsPath', () => {
        const result = client.projectZoneClusterComponentSettingsPath(
          'projectValue',
          'zoneValue',
          'clusterValue',
          'componentValue'
        ...
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectZoneClusterComponentSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectZoneClusterComponentSettingsName', () => {
        const result = client.matchProjectFromProjectZoneClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchZoneFromProjectZoneClusterComponentSettingsName', () => {
        const result = client.matchZoneFromProjectZoneClusterComponentSettingsName(
          fakePath
        );
      ...
      it('matchClusterFromProjectZoneClusterComponentSettingsName', () => {
        const result = client.matchClusterFromProjectZoneClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'clusterValue');
        assert(
      ...
      it('matchComponentFromProjectZoneClusterComponentSettingsName', () => {
        const result = client.matchComponentFromProjectZoneClusterComponentSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'componentValue');
        assert(
    ...
    describe('projectZoneClusterSettings', () => {
      ...
      client.initialize();
      client.pathTemplates.projectZoneClusterSettingsPathTemplate.render = sinon
        .stub()
        .returns(fakePath);
      client.pathTemplates.projectZoneClusterSettingsPathTemplate.match = sinon
        .stub()
        .returns(expectedParameters);

      it('projectZoneClusterSettingsPath', () => {
        const result = client.projectZoneClusterSettingsPath(
          'projectValue',
          'zoneValue',
          'clusterValue'
        );
        assert.strictEqual(result, fakePath);
        assert(
          (client.pathTemplates.projectZoneClusterSettingsPathTemplate
            .render as SinonStub)
            .getCall(-1)
            .calledWith(expectedParameters)
        );
      ...
      it('matchProjectFromProjectZoneClusterSettingsName', () => {
        const result = client.matchProjectFromProjectZoneClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'projectValue');
        assert(
      ...
      it('matchZoneFromProjectZoneClusterSettingsName', () => {
        const result = client.matchZoneFromProjectZoneClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'zoneValue');
        assert(
      ...
      it('matchClusterFromProjectZoneClusterSettingsName', () => {
        const result = client.matchClusterFromProjectZoneClusterSettingsName(
          fakePath
        );
        assert.strictEqual(result, 'clusterValue');
        assert(
