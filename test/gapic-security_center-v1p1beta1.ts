...
describe('v1p1beta1.SecurityCenterClient', () => {
    ...
    describe('createNotificationConfig', () => {
        ...
        it('invokes createNotificationConfig with error', done => {
            ...
            client.createNotificationConfig(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('deleteNotificationConfig', () => {
        ...
        it('invokes deleteNotificationConfig with error', done => {
            ...
            client.deleteNotificationConfig(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('getOrganizationSettings', () => {
        ...
        it('invokes getOrganizationSettings with error', done => {
            ...
            client.getOrganizationSettings(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('updateNotificationConfig', () => {
        ...
        it('invokes updateNotificationConfig with error', done => {
            ...
            client.updateNotificationConfig(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('updateOrganizationSettings', () => {
        ...
        it('invokes updateOrganizationSettings with error', done => {
            ...
            client.updateOrganizationSettings(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('runAssetDiscovery', () => {
        it('invokes runAssetDiscovery without error', done => {
            ...
            client.runAssetDiscovery(request).then((responses: [Operation]) => {
    ...
    describe('groupAssets', () => {
        it('invokes groupAssets without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.groupAssets = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('groupAssetsStream', () => {
        it('invokes groupAssetsStream without error', done => {
            ...
            const stream = client.groupAssetsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
    ...
    describe('groupFindings', () => {
        it('invokes groupFindings without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.groupFindings = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('groupFindingsStream', () => {
        it('invokes groupFindingsStream without error', done => {
            ...
            const stream = client.groupFindingsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listAssets', () => {
        it('invokes listAssets without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listAssets = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listAssetsStream', () => {
        it('invokes listAssetsStream without error', done => {
            ...
            const stream = client.listAssetsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listFindings = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listFindingsStream', () => {
        it('invokes listFindingsStream without error', done => {
            ...
            const stream = client.listFindingsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listNotificationConfigs', () => {
        it('invokes listNotificationConfigs without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listNotificationConfigs = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
            client.listNotificationConfigs(request, (err: FakeError, response: {}) => {
                assert.ifError(err);
                assert.deepStrictEqual(response, expectedResponse);
                done();
            });
    ...
    describe('listNotificationConfigsStream', () => {
        it('invokes listNotificationConfigsStream without error', done => {
            ...
            const stream = client.listNotificationConfigsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listSources', () => {
        it('invokes listSources without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listSources = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listSourcesStream', () => {
        it('invokes listSourcesStream without error', done => {
            ...
            const stream = client.listSourcesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
