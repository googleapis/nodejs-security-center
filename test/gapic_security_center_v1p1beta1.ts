...
describe('v1p1beta1.SecurityCenterClient', () => {
    ...
    describe('createSource', () => {
        it('invokes createSource without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1p1beta1.Source());
    ...
    describe('createFinding', () => {
        it('invokes createFinding without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1p1beta1.Finding());
    ...
    describe('createNotificationConfig', () => {
        it('invokes createNotificationConfig without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1p1beta1.NotificationConfig());
        ...
        it('invokes createNotificationConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.createNotificationConfig(request); }, expectedError);
            assert((client.innerApiCalls.createNotificationConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteNotificationConfig', () => {
        ...
        it('invokes deleteNotificationConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteNotificationConfig(request); }, expectedError);
            assert((client.innerApiCalls.deleteNotificationConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getNotificationConfig', () => {
        ...
        it('invokes getNotificationConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.getNotificationConfig(request); }, expectedError);
            assert((client.innerApiCalls.getNotificationConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getOrganizationSettings', () => {
        it('invokes getOrganizationSettings without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1p1beta1.OrganizationSettings());
    ...
    describe('updateNotificationConfig', () => {
        ...
        it('invokes updateNotificationConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateNotificationConfig(request); }, expectedError);
            assert((client.innerApiCalls.updateNotificationConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSecurityMarks', () => {
        it('invokes updateSecurityMarks without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1p1beta1.SecurityMarks());
    ...
    describe('listNotificationConfigs', () => {
        ...
        it('invokes listNotificationConfigs with error', async () => {
            ...
            await assert.rejects(async () => { await client.listNotificationConfigs(request); }, expectedError);
            assert((client.innerApiCalls.listNotificationConfigs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
