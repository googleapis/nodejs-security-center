...
describe('v1beta1.SecurityCenterClient', () => {
    ...
    describe('createSource', () => {
        it('invokes createSource without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.CreateSourceRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.Source());
        ...
        it('invokes createSource with error', async () => {
            ...
            await assert.rejects(async () => { await client.createSource(request); }, expectedError);
            assert((client.innerApiCalls.createSource as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createFinding', () => {
        it('invokes createFinding without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.Finding());
        ...
        it('invokes createFinding with error', async () => {
            ...
            await assert.rejects(async () => { await client.createFinding(request); }, expectedError);
            assert((client.innerApiCalls.createFinding as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getOrganizationSettings', () => {
        it('invokes getOrganizationSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GetOrganizationSettingsRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.OrganizationSettings());
        ...
        it('invokes getOrganizationSettings with error', async () => {
            ...
            await assert.rejects(async () => { await client.getOrganizationSettings(request); }, expectedError);
            assert((client.innerApiCalls.getOrganizationSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSource', () => {
        it('invokes getSource without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GetSourceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes getSource with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSource(request); }, expectedError);
            assert((client.innerApiCalls.getSource as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('setFindingState', () => {
        it('invokes setFindingState without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.SetFindingStateRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes setFindingState with error', async () => {
            ...
            await assert.rejects(async () => { await client.setFindingState(request); }, expectedError);
            assert((client.innerApiCalls.setFindingState as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateFinding', () => {
        it('invokes updateFinding without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.UpdateFindingRequest());
            request.finding = {};
        ...
        it('invokes updateFinding with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateFinding(request); }, expectedError);
            assert((client.innerApiCalls.updateFinding as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateOrganizationSettings', () => {
        it('invokes updateOrganizationSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.UpdateOrganizationSettingsRequest());
        ...
        it('invokes updateOrganizationSettings with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateOrganizationSettings(request); }, expectedError);
            assert((client.innerApiCalls.updateOrganizationSettings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSource', () => {
        it('invokes updateSource without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.UpdateSourceRequest());
            request.source = {};
            request.source.name = '';
        ...
        it('invokes updateSource with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSource(request); }, expectedError);
            assert((client.innerApiCalls.updateSource as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSecurityMarks', () => {
        it('invokes updateSecurityMarks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.UpdateSecurityMarksRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.SecurityMarks());
        ...
        it('invokes updateSecurityMarks with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSecurityMarks(request); }, expectedError);
            assert((client.innerApiCalls.updateSecurityMarks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('runAssetDiscovery', () => {
        it('invokes runAssetDiscovery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes runAssetDiscovery with call error', async () => {
            ...
            await assert.rejects(async () => { await client.runAssetDiscovery(request); }, expectedError);
            assert((client.innerApiCalls.runAssetDiscovery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('groupAssets', () => {
        it('invokes groupAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupAssetsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes groupAssets with error', async () => {
            ...
            await assert.rejects(async () => { await client.groupAssets(request); }, expectedError);
            assert((client.innerApiCalls.groupAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('groupFindings', () => {
        it('invokes groupFindings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.GroupFindingsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes groupFindings with error', async () => {
            ...
            await assert.rejects(async () => { await client.groupFindings(request); }, expectedError);
            assert((client.innerApiCalls.groupFindings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAssets', () => {
        ...
        it('invokes listAssets with error', async () => {
            ...
            await assert.rejects(async () => { await client.listAssets(request); }, expectedError);
            assert((client.innerApiCalls.listAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.ListFindingsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listFindings with error', async () => {
            ...
            await assert.rejects(async () => { await client.listFindings(request); }, expectedError);
            assert((client.innerApiCalls.listFindings as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSources', () => {
        it('invokes listSources without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.securitycenter.v1beta1.ListSourcesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listSources with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSources(request); }, expectedError);
            assert((client.innerApiCalls.listSources as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
